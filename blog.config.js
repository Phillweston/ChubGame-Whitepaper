...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'The First Token Based on the ERC-100 Protocol', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://docs.chubgame.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ChubGame, ERC-100, Protocol, Whitepaper, Cryptocurrency, Finance', // 网站关键词 英文逗号隔开
